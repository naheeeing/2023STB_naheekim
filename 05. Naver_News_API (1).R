...
Client_ID <- "QO67WFHPXAl_o3llrDqo"
Client_Secret <- "BdUztRYf5f"
...
#문서 다운로드_URI 다운로드하기
doc3 <- getURL(url, httpheader = c('Content-Type' = "apllication/xml",'X-Naver-CLient-Id' = "QO67WFHPXAl_o3llrDqo", 'X-Naver-CLient-Secret' = "BdUztRYf5f"))
doc3
